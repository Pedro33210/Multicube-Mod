...
@Mod("multicube")
public class MulticubeMod {
	public static final Logger LOGGER = LogManager.getLogger(MulticubeMod.class);
	public static final String MODID = "multicube";
